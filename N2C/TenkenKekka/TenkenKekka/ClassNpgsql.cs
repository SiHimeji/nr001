...
namespace Syuyaku
{
    public static  class ClassNpgsql
    {
        ...
        ///     Npgsql.5.0.5
        //SI
        //private static string conn_str = "Server=192.168.1.217;Port=5432;User ID=postgres;Database=postgres;Password=123456;Enlist=true";
        //旧
        ...
        //
        //
        public static void _EXEC(String StrSQL)
        {
